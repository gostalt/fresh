...
func (e *ErrNotFound) Error() string {
	return fmt.Sprintf("entity: %s not found", e.label)
}
...
func (e *ErrNotSingular) Error() string {
	return fmt.Sprintf("entity: %s not singular", e.label)
}
...
func (e ErrConstraintFailed) Error() string {
	return fmt.Sprintf("entity: unique constraint failed: %s", e.msg)
}
